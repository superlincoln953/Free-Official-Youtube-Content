...
If you don't know of any YouTube channels that fit thr description but still want to contribute, you can do so by suggesting some small descriptions, possibly following the simple formula, for the channels which don't have one, or report eventual inaccurate descriptions or typos.
